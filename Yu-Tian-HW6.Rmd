...
From the matrix above, we can find there is no negative correlation among all these variables. Total (sum of all stats) has a strong positive correlation with alomost all other variables. Besides, (1) Defense and sp_def (special defense against special attacks), (2) attack and sp_atk (special attack), (3) sp_def and sp_attack, (4) attack and defense also have strong positive correlation. 
...
min_n means the minimum number of data points in a nod required for the node to continue split
